    ...
    return (
        <div className="NavbarUser">
            <ul className='NavbarUser__list'>
                ...
                <li><a className='NavbarUser__button NavbarUser__button--primary' href='/login'>Log in</a></li>
                <li><a className='NavbarUser__button NavbarUser__button--secondary' href='/create-account'>Sign In</a></li>
